                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="https://gmail.com/username"
                    />
                  </div>
                  <div className="space-y-2">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="text-center">
                   {imagePreview ? (
                  <div
                    className="w-20 h-20 lg:h-24 lg:w-24 mx-auto mb-4 rounded-full overflow-hidden flex justify-center items-center bg-cover bg-center"
                    style={{ backgroundImage: `url(${imagePreview})` }}
                  ></div>
                ) : (
                    ...
                    {Object.entries(profile.socialLinks).map(([platform, url]) => (
                      url ? (
                        <div key={platform} className="flex items-center text-sm">
                          ...
                          {platform === 'twitter' && <Mail className="mr-2 h-4 w-4" />}
